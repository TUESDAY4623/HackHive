...
import { Eye, EyeOff, Github, Mail, Lock, Hexagon } from 'lucide-react';
  ...
  return (
    <div className={styles.authPage}>
      <div className={`${styles.authCard} animate-fade-in-up`}>
        ...
        <p className={styles.subtitle}>Sign in to continue your hackathon journey</p>
        ...
        <p className={styles.switchLink}>
          New to HackHive?{' '}
          <Link href="/auth/register" className={styles.link}>Create an account</Link>
        </p>
      </div>
    </div>
  );
